    ...
    def __init__(self,root):
      ...
      #====options===
       ...
       # txt_Search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=850,y=80)
        ...
        #=====title===
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="#07D6CC",fg="Black").place(x=50,y=10,width=1000,height=40)
        
        
        #=====conetent======
        #====row1=====
        lbl_supplier_invoice=Label(self.root,text="Invoice No",font=("goudy old style",15,"bold"),bg="#B2DBD2").place(x=50,y=80)
        txt_supplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("goudy old style",15),bg="#FAFE9F").place(x=180,y=80,width=180)
       
        #=======row 2=======
        lbl_name=Label(self.root,text="Name",font=("goudy old style",15,"bold"),bg="#B2DBD2").place(x=50,y=120)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="#FAFE9F").place(x=180,y=120,width=180)
       
        #=======row 3 =======
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15,"bold"),bg="#B2DBD2").place(x=50,y=160)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="#FAFE9F").place(x=180,y=160,width=180)
       
        
         #=======row 4 =======
        lbl_desc=Label(self.root,text="Description",font=("goudy old style",15,"bold"),bg="#B2DBD2").place(x=50,y=220)
        txt_desc=Entry(self.root,textvariable=self.var_desc,font=("goudy old style",15),bg="#FAFE9F").place(x=180,y=220,width=450,height=90)
