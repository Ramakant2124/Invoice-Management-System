...
class BillClass:
    def __init__(self,root):
        ...
        self.chk_print=0
        #===title===
        self.icon_title=PhotoImage(file="Image/Rainbow.png")
        title=Label(self.root,text="Rainbow Suppliers",image=self.icon_title,compound=LEFT,font=("times new roman",40,"bold"),bg="#ABB2B9",fg="Black",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)

        #===btn_logout===
        btn_logout=Button(self.root,text="Logout",font=("times new roman",15,"bold"),bg="#86A1EF",cursor="hand2").place(x=1150,y=10,height=50,width=150)

        #===clock===
        self.lbl_clock=Label(self.root,text="Rainbow Suppliers\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="black",fg="white")
        ...
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times new roman",15),bg="#FAFE9F").place(x=128,y=47,width=150,height=22)
        ...
        txt_name=Entry(CustomerFrame,textvariable=self.var_cname,font=("times new roman",13),bg="#FAFE9F").place(x=80,y=35,width=180)
        
        lbl_contact=Label(CustomerFrame,text="Contact No.",font=("times new roman",15),bg="white").place(x=270,y=35)
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times new roman",13),bg="#FAFE9F").place(x=380,y=35,width=140)
        ...
        txt_p_name=Entry(Add_CartWidgetsFrame,textvariable=self.var_pname,font=("times new roman",13),bg="#FAFE9F",state='readonly').place(x=5,y=35,width=190,height=22)

        lbl_p_price=Label(Add_CartWidgetsFrame,text="Price Per Qty",font=("times new roman",15),bg="white").place(x=230,y=5)
        txt_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new roman",13),bg="#FAFE9F",state='readonly').place(x=230,y=35,width=150,height=22)

        lbl_p_qty=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        txt_p_qty=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new roman",13),bg="#FAFE9F").place(x=390,y=35,width=120,height=22)
        ...
        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#B36FF4",fg="Black").pack(side=TOP,fill=X)
        ...
        self.lbl_discount=Label(billMenuFrame,text='Discount \n[10%]',font=("goudy old style",15,"bold"),bg="#8bc34a",fg="Black")
        ...
        btn_print=Button(billMenuFrame,text='Print Bill',command=self.print_bill,cursor="hand2",font=("goudy old style",15,"bold"),bg="lightgreen",fg="Black")
        ...
        btn_genrate=Button(billMenuFrame,text='Generate/Save Bill',command=self.generate_bill,cursor="hand2",font=("goudy old style",15,"bold"),bg="#009688",fg="Black")
        btn_genrate.place(x=246,y=80,width=160,height=50)

        #====Footer=====
        footer=Label(self.root,text="Rainbow Suppliers \n Email : rainbow.girish@gmail.com",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def bill_updates(self):
        ...
        self.discount=(self.bill_amount*10)/100
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Rainbow Suppliers\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
