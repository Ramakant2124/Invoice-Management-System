...
class IMS:
    def __init__(self,root):
        ...
        #===btn_logout===
        btn_logout=Button(self.root,text="Logout",command=self.logout,font=("times new roman",15,"bold"),bg="#20C0C0",cursor="hand2").place(x=1150,y=10,height=50,width=150)

        #===clock===
        self.lbl_clock=Label(self.root,text="Rainbow Suppliers\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("times new roman",15),bg="#000000",fg="White")
        self.lbl_clock.place(x=0,y=70,relwidth=1,height=30)

        #===Left Menu===
        
        self.MenuLogo=Image.open("Image/Rainbow1.png")
        self.MenuLogo=self.MenuLogo.resize((210,170))
        self.menu_logo=ImageTk.PhotoImage(self.MenuLogo)
     ...
     #===Content===
        ...
        self.lbl_employee=Label(self.root,text="Total Employee\n[ 0 ]",bd=5,relief=RIDGE,bg="#33bbf9",fg="Black",font=("goudy old style",20,"bold"))
        self.lbl_employee.place(x=300,y=120,height=150,width=300)

        self.lbl_supplier=Label(self.root,text="Total Suppliers\n[ 0 ]",bd=5,relief=RIDGE,bg="#EC7063",fg="Black",font=("goudy old style",20,"bold"))
        self.lbl_supplier.place(x=650,y=120,height=150,width=300)

        self.lbl_category=Label(self.root,text="Total Categories\n[ 0 ]",bd=5,relief=RIDGE,bg="#009688",fg="Black",font=("goudy old style",20,"bold"))
        self.lbl_category.place(x=1000,y=120,height=150,width=300)

        self.lbl_product=Label(self.root,text="Total Product\n[ 0 ]",bd=5,relief=RIDGE,bg="#607d8b",fg="Black",font=("goudy old style",20,"bold"))
        self.lbl_product.place(x=300,y=300,height=150,width=300)

        self.lbl_sales=Label(self.root,text="Total Sales\n[ 0 ]",bd=5,relief=RIDGE,bg="#F7DC6F",fg="Black",font=("goudy old style",20,"bold"))
        self.lbl_sales.place(x=650,y=300,height=150,width=300)
        
        #===footer===
        lbl_footer=Label(self.root,text="Rainbow Suppliers \n Gala No.9 A Sector, 62\63, Co.Op.Industrial Estate,Jalgaon-425003",font=("times new roman",15,"bold"),bg="#ABB2B9",fg="Black").pack(side=BOTTOM,fill=X)
