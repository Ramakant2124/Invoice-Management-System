...
class Productclass:
    def __init__(self,root):
        ...
        title=Label(product_Frame,text="Manage Product Details",font=("goudy old style",18,"bold"),bg="#08F5E9",fg="Black").pack(side=TOP,fill=X)
      ...
      #======column1
        ...
        txt_name=Entry(product_Frame,textvariable=self.var_name,font=("goudy old style",15),bg='#FAFE9F').place(x=150,y=160,width=200)
        txt_price=Entry(product_Frame,textvariable=self.var_price,font=("goudy old style",15),bg='#FAFE9F').place(x=150,y=210,width=200)
        txt_qty=Entry(product_Frame,textvariable=self.var_qty,font=("goudy old style",15),bg='#FAFE9F').place(x=150,y=260,width=200)
