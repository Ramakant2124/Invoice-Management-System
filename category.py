...
class categoryClass:
    def __init__(self,root):
     ...
     #===================title====================   
        lbl_title=Label(self.root,text="Manage Product Category",font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=50,y=10,width=1000,height=40)   
        
        lbl_name=Label(self.root,text="Enter Category Name ",font=("goudy old style",30,"bold"),bg="white",).place(x=50,y=100)   
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",18,),bg="#FAFE9F").place(x=50,y=170,width=300)
